...
\newcommand{\PyQtFourGpl}{\ulink{PyQt4-gpl-4.0.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-gpl-4.0.tar.gz}}
...
\newcommand{\PyQwtTarGz}{\ulink{PyQwt5-\cvs.tar.gz}
  {http://prdownloads.sourceforge.net/pyqwt5/PyQwt5-\cvs.tar.gz?download}}
...
\begin{enumerate}
  ...
  \item
    ...
    Supported versions: PyQt4-4.0, and PyQt-3.16.
  \item
