...
\newcommand{\Sip}{\ulink{sip-4.7.5.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.7.5.tar.gz}}
...
\newcommand{\PyQtFourGpl}{\ulink{PyQt-x11-gpl-4.4.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-4.4.tar.gz}}
\newcommand{\PyQtFourMac}{\ulink{PyQt-mac-gpl-4.4.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-4.4.tar.gz}}
...
\newcommand{\NumPyExe}{\ulink{numpy-1.1.0.win32-py2.5.exe}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0.3.win32-py2.5.exe}}
\newcommand{\QtExe}{\ulink{qt-win-opensource-4.3.3-mingw.exe}
...
\newcommand{\PrerequisitesEnd}{
  ...
  \Qwt-5.1 bugfix branch which fixes some bugs in \Qwt-5.1.0.
  However, \Qwt-5.0.0, \Qwt-5.0.1, and \Qwt-5.0.2 are also supported.
  I recommend to compile and link the bugfix branch statically into PyQwt.
...
My \file{.pythonrc.py} file tries to import the modules \module{numpy} and
\module{scipy}.
Then, it tries to import everything from the modules \module{PyQt4.Qt} and
\module{PyQt4.Qwt5} before creating an QApplication instance.
...
{\ulink{PyQt-gpl-4.3.3}{http://www.riverbankcomputing.com/Downloads/PyQt4/GPL/}
for Windows.
