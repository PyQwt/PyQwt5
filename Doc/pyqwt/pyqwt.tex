...
\newcommand{\PyQtFourGpl}{\ulink{PyQt4.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt4.tar.gz}}
...
\newcommand{\PyQwtTarGz}{\ulink{PyQwt5-\version.tar.gz}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt5-\version.tar.gz?download}}
...
\begin{enumerate}
  ...
  \item
    ...
    Supported versions: Qt-4.1.x, Qt-3.3.x, and Qt-3.2.x.
  \item
    \Sip{}.\\
    Supported versions: sip-4.4.x,
  \item
    Either \PyQtGpl{}, or \PyQtMac{}, or \PyQtFourGpl{}.\\
    Supported versions: PyQt4, and PyQt-3.16.
  \item
...
When PyQwt has been built for Qt-4, this class is replaced by \class{QPointF}.
\end{classdesc*}
...
\begin{classdesc*}{QwtSpline}
  ...
  \begin{cfuncdesc}{bool}{recalc}{
      double *x, double *y, int n, bool periodic = false}
    is implemented as
    \begin{verbatim}
success = spline.recalc(x, y, periodic)
  ...
  \begin{cfuncdesc}{void}{copyValues}{bool enable = true}
