...
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.17.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.17.tar.gz}}
\newcommand{\PyQtMac}{\ulink{PyQt-mac-gpl-3.17.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-3.17.tar.gz}}
\newcommand{\PyQtFourGpl}{\ulink{PyQt4-x11-gpl-4.1.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-4.1.1.tar.gz}}
\newcommand{\PyQtFourMac}{\ulink{PyQt-mac-gpl-4.1.1.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-4.1.1.tar.gz}}
...
\newcommand{\PyQwtTarGz}{\ulink{PyQwt-\cvs.tar.gz}
...
\newcommand{\PrerequisitesEnd}{
  The source package in the \PyQwtTarGz{} contains a subversion snapshot of the
  \Qwt-5.0 bugfix branch fixing bugs in \Qwt-5.0.1.
