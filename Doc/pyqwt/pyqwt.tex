...
Subsections \ref{old-release} and/or \ref{old-release} explain how to install
...
\item \NumPyExe{}.
\item \QtOldExe{}.\\
  Let \QtOldExe{} install MinGW if for instance \DevCpp{} has not been
  installed before \QtOldExe{}.
\item \PyQtOldExe{}.\\
...
\item \NumPyExe{}.
\item \QtNewExe{}.\\
  Let \QtNewExe{} install MinGW if for instance \DevCpp{} has not been
  installed before \QtNewExe{}.
\item \PyQtNewExe{}.\\
  Make sure that you can run the PyQt examples by tweaking the environment
  variables.
