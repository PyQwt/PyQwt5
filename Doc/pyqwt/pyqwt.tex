...
\newcommand{\Sip}{\ulink{sip-4.7.3.tar.gz}
  {http://pyqwt.sourceforge.net/support/sip-4.7.3.tar.gz}}
...
\newcommand{\PyQtFourGpl}{\ulink{PyQt-x11-gpl-4.3.3.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-4.3.3.tar.gz}}
\newcommand{\PyQtFourMac}{\ulink{PyQt-mac-gpl-4.3.3.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-4.3.3.tar.gz}}
\newcommand{\NumPy}{\ulink{NumPy}
  {http://numpy.scipy.org}}
\newcommand{\NumPyTarGz}{\ulink{NumPy-1.0.4.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0.4.tar.gz?download}}
