...
\newcommand{\PyQtGpl}{\ulink{PyQt-x11-gpl-3.18.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-3.18.tar.gz}}
\newcommand{\PyQtMac}{\ulink{PyQt-mac-gpl-3.18.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-3.18.tar.gz}}
\newcommand{\PyQtFourGpl}{\ulink{PyQt4-x11-gpl-4.2.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-x11-gpl-4.2.tar.gz}}
\newcommand{\PyQtFourMac}{\ulink{PyQt-mac-gpl-4.2.tar.gz}
  {http://pyqwt.sourceforge.net/support/PyQt-mac-gpl-4.2.tar.gz}}
\newcommand{\NumPy}{\ulink{NumPy}
  {http://numpy.scipy.org}}
\newcommand{\NumPyTarGz}{\ulink{NumPy-1.0.2.tar.gz}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0.2.tar.gz?download}}
...
\newcommand{\PythonExe}{\ulink{python-2.5.msi}
  {http://www.python.org/ftp/python/2.5/python-2.5.msi}}
\newcommand{\NumPyExe}{\ulink{numpy-1.0.2.win32-py2.5.exe}
  {http://prdownloads.sourceforge.net/numpy/numpy-1.0.2.win32-py2.5.exe}}
...
\newcommand{\PyQwtOldExe}{\ulink{PyQwt-5.0.0-Python2.5-Qt4.2.2-PyQt-4.1.1.exe}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt-5.0.0-Python2.5-Qt4.2.2-PyQt4.1.1-NumPy1.0.2.exe}}
\newcommand{\PyQwtNewExe}{\ulink{PyQwt-5.0.0-Python2.5-Qt4.2.3-PyQt-4.2-NumPy1.0.2.exe}
  {http://prdownloads.sourceforge.net/pyqwt/PyQwt-5.0.0-Python2.5-Qt4.2.3-PyQt-4.2-NumPy1.0.2.exe}}


\newcommand{\PrerequisitesEnd}{
  The source package \PyQwtTarGz{} contains a subversion snapshot of the
  \Qwt-5.0 bugfix branch which fixes some bugs in \Qwt-5.0.1.
  It is best to compile and link the bugfix branch statically into PyQwt,
  as long as \Qwt-5.0.2 has not been released.
...
\newcommand{\Future}{
  \begin{notice}[warning]
    The documentation is for PyQwt-5.0.0 which has not yet been released. A
    snapshot, \PyQwtCvsTarGz{}, is available. Please refer, to the
...
\begin{enumerate}
  ...
  \item
    \Sip{} (to be released in April 2007).\\
    Supported versions: sip-4.6.x, and sip-4.5.x.
  \item
    Either \PyQtGpl{}, or \PyQtMac{}, or \PyQtFourGpl{}, or \PyQtFourMac{} (to
    be released in April 2007).\\
    Supported versions: PyQt-4.2.x, PyQt-4.1.x, PyQt-3.18.x, and PyQt-3.17.x.
\end{enumerate}
...
Subsections \ref{old-release} and/or \ref{new-release} explain how to install
PyQwt in combination with PyQt-4.1.1 and/or PyQt-4.2, respectively. 

\subsection{Binary Installer for PyQt-4.1.1
  \label{old-release}}
...
\item \QtNewExe{}.\\
  Let the Qt installer install MinGW if for instance \DevCpp{} has not been
  installed before Qt.
\item \PyQtNewExe{} (to be released in April 2007).\\
  Make sure that you can run the PyQt examples by tweaking the environment
  variable \var{PATH}.
\item Install \PyQwtNewExe{} (to be released in April 2007).
\end{enumerate}
